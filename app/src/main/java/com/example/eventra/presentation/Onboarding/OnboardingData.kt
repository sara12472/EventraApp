...
val onboardingItem=listOf<OnboardingData>(
    OnboardingData(image= R.drawable.onboarding1,
        ...
        description = "Create, manage, and organize your events in\n" +
                " one place with a clean and simple experience."),

    OnboardingData(image=R.drawable.onboarding2,
        tittle = "Never Miss a Reminder",
        description = "Get timely notifications and smart reminders \n" +
                "so you’re always on track."),
    OnboardingData(image = R.drawable.onboarding3, tittle = " Stay Organized Every Day",
        description = "Keep your schedule organized and your day\n" +
                " stress-free with powerful planning tools.")
